          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('DAILY MEALS', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400, color: Color(0x61FDFBD4), letterSpacing: 1.5)),
              ),
              ...
              const Padding(
                padding: EdgeInsets.only(left: 4.0),
                child: Text('SUGGESTED RECIPES', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400, color: Color(0x61FDFBD4), letterSpacing: 1.5)),
              ),
              const SizedBox(height: 12),
              _buildRecipeList(),
              const SizedBox(height: 24),
      ...
      child: Column(
        children: [
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                     const Text('REMAINING', style: TextStyle(color: Color(0x3DFDFBD4), fontSize: 9, letterSpacing: 1.5)),
                     const SizedBox(height: 2),
                     Text('${_targetCalories.toInt()}', 
                      style: const TextStyle(fontSize: 32, fontWeight: FontWeight.w300, color: Color(0xFFFDFBD4))),
                     const Text('kcal', style: TextStyle(color: Color(0x1FFDFBD4), fontSize: 12)),
                  ],
                ),
              ),
              Stack(
                ...
                children: [
                  ...
                  const Text('65%', style: TextStyle(fontSize: 12, color: Color(0xFF42A5F5))),
                ],
              ),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _buildMacroItem('Protein', '110/180g', 0.6, const Color(0xFFAB47BC)),
  ...
  Widget _buildMacroItem(String label, String val, double progress, Color color) {
    return Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: const TextStyle(color: Color(0x3DFDFBD4), fontSize: 9, letterSpacing: 0.5)),
          const SizedBox(height: 2),
          Text(val, style: const TextStyle(fontSize: 11, color: Color(0x99FDFBD4), fontWeight: FontWeight.w300)),
  ...
  Widget _buildMealCard(String title, String kcal, IconData icon, Color accentColor) {
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: const Text('No meals added yet', style: TextStyle(color: Color(0x3DFDFBD4), fontSize: 11)),
        trailing: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(kcal, style: const TextStyle(fontWeight: FontWeight.w300, color: Color(0x8AFDFBD4))),
            const SizedBox(width: 8),
            const Icon(Icons.chevron_right, color: Color(0x1AFDFBD4), size: 16),
          ],
        ),
      ),
    );
        ...
        children: [
          ClipRRect(
            ...
            child: Image.network(imageUrl, height: 80, width: double.infinity, fit: BoxFit.cover, 
              errorBuilder: (c, e, s) => Container(height: 80, color: Color(0xFFFDFBD4).withOpacity(0.05))),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(kcal, style: const TextStyle(color: Color(0x3DFDFBD4), fontSize: 10)),
                    Text(time, style: const TextStyle(color: Color(0x3DFDFBD4), fontSize: 10)),
                  ],
                ),
              ],
            ),
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(color: Color(0xB3FDFBD4), fontSize: 13, height: 1.4, fontWeight: FontWeight.w300),
            ),
          ),
        ],
      ),
