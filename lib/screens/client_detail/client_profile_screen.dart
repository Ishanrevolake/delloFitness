    ...
    return InkWell(
      ...
      child: Column(
        children: [
          ...
          child: Icon(icon, color: const Color(0xFF3EB489)),
        ),
              ...
              LineChartData(
                ...
                lineBarsData: [
                  LineChartBarData(
                    ...
                    barWidth: 4,
                    dotData: FlDotData(show: true, getDotPainter: (p0, p1, p2, p3) => FlDotCirclePainter(color: Colors.white, strokeWidth: 2, strokeColor: const Color(0xFF3EB489), radius: 4)),
                  ),
                ],
              ),
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(trend, style: TextStyle(color: trend.contains('+') ? const Color(0xFF3EB489) : Colors.black54, fontSize: 10)),
        ],
      ),
    );
  }
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              const Text('60 mins', style: TextStyle(color: Color(0xFF3EB489), fontSize: 12)),
